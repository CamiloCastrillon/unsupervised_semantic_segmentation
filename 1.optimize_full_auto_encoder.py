...
dataset        = np.load('C:/camilo/uss/datasets/full_auto_encoder/dataset_dim25_tests.npy')
nl_min         = 1
nl_max         = 3
dim            = 25
lr_min         = 0.0001
...
ofa = ofa(dataset, nl_min, nl_max, dim, lr_min, lr_max, ep_min, ep_max, ba_min, ba_max, ink, mode_l1, rl1_min, rl1_max, mode_l2, rl2_min, rl2_max, 
          mode_do, do_min, do_max, esp_min, esp_max, n_trials, pth_save_params, umbral, pth_save_model, pth_save_hist)
